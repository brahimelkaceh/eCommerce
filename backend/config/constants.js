...
module.exports.CATEGORY_DELETE_FAILED =
  "Category deletion failed , check if Category has no subCategories ";
...
module.exports.SUB_CATEGORY_DELETE_FAILED =
  "SubCategory deletion failed , check if Category has no subCategories ";
...
module.exports.PRODUCT_DELETE_FAILED =
  "Product deletion failed , check if Category has no subCategories ";
...
module.exports.ORDER_CANCELED_FAILED =
  "order cancel failed , check if Category has no subCategories ";
...
module.exports.SERVER_ERROR_MESSAGE =
  "Something bad happend. It's not you, it's me.";
