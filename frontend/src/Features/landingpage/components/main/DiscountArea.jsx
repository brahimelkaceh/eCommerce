...
style={{width:"100%" , backgroundSize: 'cover', backgroundImage: `url('/src/assets/img/bg/discount_bg.jpg')`}} >
  <div className="container">
    <div className="row justify-content-center justify-content-lg-start">
      <div className="col-lg-6 col-md-10">
        <div className="discount-content text-center">
          <div className="icon mb-15"><img src="/src/assets/img/icon/discount_icon.png" alt /></div>
