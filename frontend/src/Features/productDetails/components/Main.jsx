          ...
          <div className="row">
                ...
                <div className="shop-details-nav-wrap">
                  <ul className="nav nav-tabs" id="myTab" role="tablist">
                    <li className="nav-item" role="presentation">
                      ...
                      >
                        <img
                          src="img/product/sd_nav_img01.jpg"
                          width="99"
                          height="117"
                          alt
                        />
                    ...
                    <li className="nav-item" role="presentation">
                      ...
                      >
                        <img
                          src="img/product/sd_nav_img02.jpg"
                          width="99"
                          height="117"
                          alt
                        />
                    ...
                    <li className="nav-item" role="presentation">
                      ...
                      >
                        <img
                          src="img/product/sd_nav_img03.jpg"
                          width="99"
                          height="117"
                          alt
                        />
                  ...
                  <div className="tab-content" id="myTabContent">
                    ...
                    >
                      <div className="shop-details-img">
                        <img
                          src="img/product/shop_details_img01.jpg"
                          width="621"
                          height="689"
                          alt
                        />
            ...
            <div className="col-lg-5">
              <div className="shop-details-content">
                ...
                <p className="style-name">Product Sku: 82600800</p>
